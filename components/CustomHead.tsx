...
export const CustomHead = ({ title, description, image, url }: Props): JSX.Element => {
  ...
  return (
    <Head>
      ...
      <meta property="og:image" content={`https://og-image.hiroyukiyagihashi.vercel.app/テスト.png`} />
      <meta property="og:image:secure_url" content={`https://og-image.hiroyukiyagihashi.vercel.app/テスト.png`} />
      ...
      <meta name="twitter:image" content={`https://og-image.hiroyukiyagihashi.vercel.app/テスト.png`} />
